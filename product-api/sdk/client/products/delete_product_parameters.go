...
// WithName adds the name to the delete product params
func (o *DeleteProductParams) WithName(name string) *DeleteProductParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the delete product params
func (o *DeleteProductParams) SetName(name string) {
	o.Name = name
}
