...
func (o *DeleteProductCreated) Error() string {
	return fmt.Sprintf("[DELETE /products/{name}][%d] deleteProductCreated ", 201)
}
...
func (o *DeleteProductNotFound) Error() string {
	return fmt.Sprintf("[DELETE /products/{name}][%d] deleteProductNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteProductNotImplemented) Error() string {
	return fmt.Sprintf("[DELETE /products/{name}][%d] deleteProductNotImplemented  %+v", 501, o.Payload)
}
